...
class ExamsListController extends MyController {
	...
	public function create(){
		...
		$examsList->examTerm = Input::get('examTerm');
		$examsList->timesSchoolOpen = Input::get('timesSchoolOpen');
		$examsList->closingDate = $this->panelInit->dateToUnix(Input::get('closingDate'));
		$examsList->resumptionDate = $this->panelInit->dateToUnix(Input::get('resumptionDate'));
		$examsList->save();
