...
<html>
  <head>
    ...
    <link href="<?php echo URL::asset('assets/plugins/iCheck/square/blue.css'); ?>" rel="stylesheet" type="text/css" />
  ...
  <body class="hold-transition login-page loginMark">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <a target="_BLANK" href="<?php echo URL::to('/terms'); ?>"><?php echo $panelInit->language['schoolTerms']; ?></a><br/>
        <a href="<?php echo URL::to('/forgetpwd'); ?>"><?php echo $panelInit->language['restorePwd']; ?></a><br/>
    ...
    <script src="<?php echo URL::asset('assets/plugins/iCheck/icheck.min.js'); ?>"></script>
    <script>
      $(function () {
        $('input').iCheck({
